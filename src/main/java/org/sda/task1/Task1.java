...
/*
Stwórz metodę, która jako parametr przyjmuje listę stringów, następnie zwraca
tą listę posortowaną alfabetycznie od Z do A.
*/
public class Task1 {
    ...
    private static List<String> sortDesc (List<String> list) {
        ...
        Collections.reverse(list); //sortowanie od tyłu
        return list;
    }
